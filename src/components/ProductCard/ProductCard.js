...
export const ProductCard = ({ product }) => {
  const { _id, name, img, alt, brand, newPrice, oldPrice, discount, rating } =
    product;
      ...
      <div class="card-details">
        ...
        <div class="card-description">
          ...
          <p className="d-flex align-center">
            {rating} <span class="material-icons-outlined star">star</span>
          </p>
        </div>
        <div class="cta-btn">
          <button
            ...
            onClick={
              isItemInCart || isItemSaved ? handleGoToCart : handleAddToCart
            }
          >
